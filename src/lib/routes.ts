 ...
 * onboarding hook, the root page, the auth route-group layout, the Supabase proxy, and the
 * safe-redirect fallback. Changing seven of eight is how a split-brain redirect ships, where the
 * page you reach depends on which door you came through.
 *
